...
import net.lbtech.redis.core.RedisHashClient;
 ...
 *
 */
public class RedisHashClientImpl extends RedisClient implements RedisHashClient {

	public RedisHashClientImpl(RedisTemplate<Serializable, Serializable> redisTemplate) {
		super(redisTemplate);
	}
	/**
